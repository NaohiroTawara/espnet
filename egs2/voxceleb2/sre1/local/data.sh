...
if [ $stage -le 1 ]; then
    log "stage 1: Download and convert"
    if [ -z "${user}" ]; then
...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
    ...
    [ ! -e ${VOXCELEB2}/veri_test.txt ] && wget http://www.robots.ox.ac.uk/~vgg/data/voxceleb/meta/veri_test.txt -P ${VOXCELEB2}/
    [ ! -e ${VOXCELEB2}/train_test.txt ] && wget http://www.robots.ox.ac.uk/~vgg/data/voxceleb/meta/train_list.txt -P ${VOXCELEB2}/
