if [[ "$(hostname -d)" == clsp.jhu.edu ]]; then
    ...
    VOXCELEB1=downloads/vox1
    VOXCELEB2=downloads/vox2
    SWBD_CELLULAR1=LDC/LDC2001S13
    SWBD_CELLULAR2=LDC/LDC2004S07
    SWBD_PHASE1=LDC/LDC98S75
    SWBD_PHASE2=LDC/LDC99S79
    SWBD_PHASE3=LDC/LDC2002S06
    SRE2008_TRAIN=LDC/LDC2011S05
    SRE2008_TEST=LDC/LDC2011S08
    SRE2004=LDC/LDC2006S44
    SRE2005_TRAIN=LDC/LDC2011S01
    SRE2005_TEST=LDC/LDC2011S04
    SRE2006_TRAIN=LDC/LDC2011S09
    SRE2006_TEST1=LDC/LDC2011S10
    SRE2006_TEST2=LDC/LDC2012S01
    FISHER1=LDC/LDC2004S13
    FISHER1_TRANS=LDC/LDC2004T19
    FISHER2=LDC/LDC2005S13
    FISHER2_TRANS=LDC/LDC2005T19
fi
